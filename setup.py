...
version_py = os.path.join(os.path.dirname(__file__), "catch-test", "version.py")
...
setup(
    ...
    url="https://github.com/KrishnaswamyLab/CATCH",
    download_url="https://github.com/KrishnaswamyLab/CATCH/archive/v{}.tar.gz".format(
        version
    ),
    keywords=[
        "big-data",
